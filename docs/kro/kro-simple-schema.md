Title: Simple Schema | kro

URL Source: https://kro.run/api/specifications/simple-schema/
...
### Basic Types[​](https://kro.run/api/specifications/simple-schema/#basic-types "Direct link to Basic Types")
...
### Structure Types[​](https://kro.run/api/specifications/simple-schema/#structure-types "Direct link to Structure Types")
...
### Unstructured Objects[​](https://kro.run/api/specifications/simple-schema/#unstructured-objects "Direct link to Unstructured Objects")
...
`apiVersion: kro.run/v1alpha1kind: CRDWithUnstructuredObjectsmetadata:  name: test-instancespec:  additionalHelmChartValues:    boolean-value: true    numeric-value: 42    structural-type:      with-additional:        nested: fields    string-value: my-string    mapping-value:      - item1      - item2      - item3`

### Array Types[​](https://kro.run/api/specifications/simple-schema/#array-types "Direct link to Array Types")
...
### Map Types[​](https://kro.run/api/specifications/simple-schema/#map-types "Direct link to Map Types")
...
### Custom Types[​](https://kro.run/api/specifications/simple-schema/#custom-types "Direct link to Custom Types")
...
### Supported Markers[​](https://kro.run/api/specifications/simple-schema/#supported-markers "Direct link to Supported Markers")
...
### String Validation Markers[​](https://kro.run/api/specifications/simple-schema/#string-validation-markers "Direct link to String Validation Markers")
...
### Array Validation Markers[​](https://kro.run/api/specifications/simple-schema/#array-validation-markers "Direct link to Array Validation Markers")
...
### Single vs Multi-Expression Fields[​](https://kro.run/api/specifications/simple-schema/#single-vs-multi-expression-fields "Direct link to Single vs Multi-Expression Fields")
...
### 1. Conditions[​](https://kro.run/api/specifications/simple-schema/#1-conditions "Direct link to 1. Conditions")
...
### 2. State[​](https://kro.run/api/specifications/simple-schema/#2-state "Direct link to 2. State")
