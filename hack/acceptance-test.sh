...
k apply -f "https://github.com/kubernetes-sigs/kro/releases/download/v${KRO_VERSION}/kro-core-install-manifests.yaml"
...
k apply -f "${repo_root}/examples/kro/ready-endpoint/rgd.yaml"
