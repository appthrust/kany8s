...
{{- define "eks-karpenter-bootstrapper.aws.credentials.secretMountPath" -}}
{{- "/var/run/secrets/aws" -}}
{{- end }}

{{/* The path the shared credentials file is mounted */}}
{{- define "eks-karpenter-bootstrapper.aws.credentials.filePath" -}}
{{- printf "%s/%s" (include "eks-karpenter-bootstrapper.aws.credentials.secretMountPath" .) .Values.aws.credentials.secretKey -}}
{{- end }}
