...
KIND_CLUSTER_NAME="${KIND_CLUSTER_NAME:-kany8s-acc-multi-${timestamp}}"
...
echo "==> Running acceptance (kro, multi RGD)"
...
CLEANUP="${CLEANUP}" \
bash "${repo_root}/hack/acceptance-test-kro-reflection-multi-rgd.sh"
